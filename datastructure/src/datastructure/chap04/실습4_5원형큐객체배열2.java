...
import datastructure.chap04.Queue4.OverflowQueueException;
...
public static void main(String[] args) {
	...
	while (true) {
		...
		case 1: // 인큐
			...
			} catch(datastructure.chap04.OverflowQueueException e) {
		...
		case 2: // 디큐
			...
			} catch (datastructure.chap04.EmptyQueueException e) {
